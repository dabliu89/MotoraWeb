      ...
      <div style={styles.formContainer}>
        ...
        <form style={styles.form} onSubmit={handleSubmit}>
          <div style={styles.formGroup}>
            <label style={styles.label} htmlFor="email">Login</label>
            <input
              type="email"
              id="email"
              name="email"
        ...
        <div style={styles.links}>
          <p>Ainda não possui uma conta? <a href="/register" style={styles.link}>Criar conta.</a></p>
          <p><a href="/forgot-password" style={styles.link}>Esqueceu a senha?</a></p>
        </div>
        {message && <p>{message}</p>}
      </div>
    </div>
